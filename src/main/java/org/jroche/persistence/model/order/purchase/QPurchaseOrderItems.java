package org.jroche.persistence.model.order.purchase;
...
public class QPurchaseOrderItems extends EntityPathBase<PurchaseOrderItems> {
    ...
    public final org.jroche.persistence.model.product.QProduct product;
    ...
    public QPurchaseOrderItems(Class<? extends PurchaseOrderItems> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new org.jroche.persistence.model.product.QProduct(forProperty("product"), inits.get("product")) : null;
    }
